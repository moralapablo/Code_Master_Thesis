...
plot2 <- ggplot(df.first, aes(x=q.Taylor, y=MSE, fill=Act.Function)) + 
  geom_boxplot() + scale_y_log10() + 
  facet_grid(h.1 ~ .)  + 
  labs(fill = "Activation\n Function") + 
  xlab("Taylor approximaiton degree (q)") +  
...
plot3 <- ggplot(df.first, aes(x=q.Taylor, y=MSE, fill=Act.Function)) + 
  geom_boxplot() + scale_y_log10() + 
  facet_grid(h.1 ~ .)  + 
  labs(fill = "Activation\n Function") + 
  xlab("Taylor approximaiton degree (q)") +  
...
=======
plot3
>>>>>>> de12d218b3078290baf16095071475f91fe3f481
```
